package com.example.dailyexpense.Expense;
...
public class Expense extends Fragment implements  View.OnClickListener,DatePickerDialog.OnDateSetListener{
            ...
            case R.id.saveData:
               ...
               if (year!=0 &month!=0&day!=0){
                   for (int i=0;i<objectList.size();i++){
                       ...
                       dataBase.insert(0,objectList.get(i).getFieldName(),value,currentDate);
                   }
               }else {
